...
const project_link_style =
  "text-normal font-normal text-blue-400 border border-blue-100 rounded-lg p-2 hover:bg-blue-400 hover:text-white transition duration-200 ease-in-out \
  flex flex-row space-x-2 place-items-center px-2 py-2 text-center place-content-center";
const project_link_disabled_style =
  "text-normal font-normal italic bg-slate-50 rounded-lg p-2  \
  flex flex-row space-x-2 text-slate-300 cursor-not-allowed place-items-center px-2 py-2 text-center place-content-center";
      ...
      <div className='h-full lg:col-span-2 md:pl-2 flex flex-wrap items-center'>
        ...
        <div className='flex flex-row flex-wrap gap-x-3 gap-y-1.5 pt-2 mb-2'>
          {props.website_link && (
            ...
            >
              <FontAwesomeIcon icon={faHouse} className="fa fa-browser" />
              <p>{props.website_link == " " ? "Webpage (Coming Soon)" : "Webpage"}</p>
            </a>
          )}
          ...
          {props.paper_link && (
            ...
            >
              <span className="icon">
                <i className="ai ai-arxiv ai-1x"></i>
              </span>
              <p>{props.paper_link == " " ? "arXiv (Coming Soon)" : "arXiv"}</p>
            </a>
          )}
          ...
          {props.demo_link && (
            ...
            >
              <FontAwesomeIcon icon={faLaptop} className="fa fa-laptop" />
              <p>Demo</p>
            </a>
          )}
        </div>
