        ...
        <div className="mt-[60px] w-full flex flex-col items-center">
            ...
            <div className="w-full flex justify-center items-center mt-4">
                <a
                    ...
                    download
                >
                    <div class="flex"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="20" height="20">
                    ...
                    <span class="text-xs text-pink-400"> updated 09/14/2024 </span>
