  ...
  return (
    <AboutSection>
      ...
      <p className="about_blurb">
        ...
        <br />
        <br />
        My curiosity of everything that I haven't done is the reason why I love
        to work with technology. My background in Computer Science equips me to
        take on technical challenges. On top of enjoying the process of making
        things work, I'm also a graphic designer who gets excited about
        ...
        designer, or a developer, I want to write, design, or build work that is
