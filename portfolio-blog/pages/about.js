  ...
  return (
    <div>
      ...
      <p className={globalStyles.font_styles.p}>
        ...
        top of making things work, I am passionate about beautiful typography,
        colors, and motion. Hence, I treasure professional environments where I
        get to collaborate with designers as a developer, or work on projects
        developing tools for the creative community.
        <br />
        <br />
        In my free time, I like to experiment with my interest in storytelling.
        I strive to find ways to explain difficult technical concepts. It all
        ...
        engaging manner. I strongly believe in that the process of acquiring new
        ...
        resilient.
        <br />
        <br /> Some random fun facts: (1) My favorite artistic medium is oil on
        canvas.
      </p>
